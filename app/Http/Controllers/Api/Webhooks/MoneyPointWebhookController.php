...
class MoneyPointWebhookController extends Controller
{
    ...
    public function testWebhook(Request $request)
    {
        ...
        $testPaymentData = [
            'amount' => $request->input('amount', 32750),
            'transaction_reference' => $request->input('transaction_reference', 'TEST-' . time()),
            'order_id' => $request->input('order_id', 'DEL-891'),
            'customer_phone' => $request->input('customer_phone', '08034567890'),
    ...
    private function extractPaymentData(Request $request): array
    {
        ...
        // Handle different webhook formats from Moniepoint
        return [
